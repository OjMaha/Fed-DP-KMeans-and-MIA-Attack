...
def run_attack_once_datalevel(config_file, target_client_id_str, sample_index, target_datapoint, seed=None):
    ...
    centers_in_file = run_training(config_file, exclude_client_id_str=None, exclude_datapoint=None, seed=seed)
    ...
    centers_out_file = run_training(config_file, exclude_client_id_str=None,
                                   exclude_datapoint=(target_client_id_str, sample_index), seed=seed)
...
def main():
    ...
    for i in range(args.num_attacks):
        ...
        for mode in ['non_private', 'private']:
            ...
            try:
                is_success = run_attack_once_datalevel(config_file, target_client_id, sample_index, target_datapoint, seed=args.seed)
